    ...
    public static class PuzzleRepository
    {
        ...
        private static readonly List<ConnectionsPuzzle> Puzzles = new()
        {
            new ConnectionsPuzzle
            {
                ...
                {
                    new PuzzleGroup { CategoryDescription = "Last _", HexColor = "", Words = new List<string> { "Laugh", "Resord", "Straw", "Supper" } },
                    new PuzzleGroup { CategoryDescription = "Second _", HexColor = "", Words = new List<string> { "Coming", "Fiddle", "Guess", "Nature" } },
                    new PuzzleGroup { CategoryDescription = "Third _", HexColor = "", Words = new List<string> { "Eye", "Party", "Rail", "Rock" } },
                    new PuzzleGroup { CategoryDescription = "First _", HexColor = "", Words = new List<string> { "Aid", "Lady", "Nations", "Responder" } }
                }
            },
            new ConnectionsPuzzle
            {
                ...
                Groups = new List<PuzzleGroup>
                {
                    new PuzzleGroup { CategoryDescription = "Starting with Greek Numerical Prefixes", HexColor = "", Words = new List<string> { "Dioxide", "Monorail", "Tetracycline", "Triangle" } },
                    new PuzzleGroup { CategoryDescription = "Instruct", HexColor = "", Words = new List<string> { "Coach", "Direct", "Guide", "Train" } },
                    new PuzzleGroup { CategoryDescription = "Means", HexColor = "", Words = new List<string> { "Instrument", "Medium", "Organ", "Vehicle" } },
                    new PuzzleGroup { CategoryDescription = "Anagrams of Musical Instrument", HexColor = "", Words = new List<string> { "Abut", "Bulge", "Groan", "Voila" } }
                }
            },
            new ConnectionsPuzzle
            {
                ...
                Groups = new List<PuzzleGroup>
                {
                    new PuzzleGroup { CategoryDescription = "Discount", HexColor = "", Words = new List<string> { "Deal", "Promotion", "Sale", "Special" } },
                    new PuzzleGroup { CategoryDescription = "Poker Actions", HexColor = "", Words = new List<string> { "Call", "Check", "Fold", "Raise" } },
                    new PuzzleGroup { CategoryDescription = "Irritate", HexColor = "", Words = new List<string> { "Bug", "Nettle", "Ruffle", "Steam" } },
                    new PuzzleGroup { CategoryDescription = "Things You Can Pump", HexColor = "", Words = new List<string> { "Brakes", "Fist", "Gas", "Iron" } }
                }
            },
            new ConnectionsPuzzle
            {
